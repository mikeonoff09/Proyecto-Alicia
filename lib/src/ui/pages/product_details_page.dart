                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(
                        height: size.height,
                        width: size.width *
                            0.55, // 55% de la pantalla para imagenes
                              ...
                              children: [
                                ...
                                MyTextField(
                                  ...
                                  suffixWidget: IconButton(
                                      icon: Icon(Icons.edit),
                                      onPressed: () => this.openHtmlEditor(
                                          descriptionShortController, context)),
                                ),
                                Row(
                                  children: [
                                    Expanded(
